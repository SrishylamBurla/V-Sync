              ...
              <RecordList
                ...
                render={(item) => (
                  <button
                    type="button"
                    onClick={() =>
                      navigate(`/optical/spectacles/${item._id}`)
                    }
              ...
              action={
                completedComprehensive ? (
                  <button
                    type="button"
                    onClick={() =>
                      startSpecialized("contact_lenses")
                    }
                    className="rounded-xl border border-slate-200 bg-white px-3 py-2 text-[10px] font-bold text-slate-600 shadow-sm transition hover:bg-slate-50"
                  >
                    Consultation
                ...
                render={(item) => (
                  ...
                  >
                    <div className="flex min-w-0 items-center gap-3">
                      ...
                      <div className="min-w-0">
                        <div className="truncate text-xs font-bold text-slate-900">
                          {item.recordNumber || "Dispensing Record"}
                        </div>

                        <div className="mt-1 text-[10px] text-slate-400">
                          {item.itemType || "Optical item"} ·{" "}
                          {formatDate(
                            item.orderDate || item.jobDate,
                          )}
                        </div>
                      </div>
                    </div>
